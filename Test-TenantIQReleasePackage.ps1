...
$ZipHashPath="$ZipPath.sha256"; $ZipSidecarExists=Test-Path $ZipHashPath -PathType Leaf
...
if(-not $Quiet){
    ...
    Write-Host ("Package : {0}" -f $PackageRoot); Write-Host ("ZIP     : {0}" -f $ZipPath); Write-Host ''
