...
TenantIQ uses **TEAMS-MTG-004** to assess **meeting chat controls** in Microsoft Teams. This guidance is intentionally evidence-bound: the assistant should explain only what the uploaded TenantIQ assessment actually observed and should not infer tenant configuration that is not present in the finding evidence.

## What this check represents

This check evaluates the TenantIQ control represented by: meeting chat controls, teams meeting chat controls.
