...
try {
    ...
    Write-Host "Site Quota Size Scoring         : Not used (site maximum quotas are not compared to tenant pooled storage)"
    ...
    if ($Issues.Count -eq 0) {
        ...
        $Recommendation = "Review SharePoint tenant storage capacity and actual site utilization. Prioritize sites above 80 percent utilization, investigate unnecessary content or versions, and adjust storage management settings or tenant capacity where appropriate."
