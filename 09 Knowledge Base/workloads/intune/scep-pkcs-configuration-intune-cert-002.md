...
# Scep Pkcs Configuration

TenantIQ uses **INTUNE-CERT-002** to assess **scep pkcs configuration** in Microsoft Intune. This guidance is intentionally evidence-bound: the assistant should explain only what the uploaded TenantIQ assessment actually observed and should not infer tenant configuration that is not present in the finding evidence.

## What this check represents

This check evaluates the TenantIQ control represented by: scep pkcs configuration, scep and pkcs configuration.
