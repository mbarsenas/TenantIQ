...
function Brand() {
  return (
    ...
    >
      <img
        src="/tenantiq-header-logo.png"
        alt="TenantIQ — Microsoft 365 Intelligence"
...
function WhatTenantIQDoes() {
  ...
  return (
    <div id="what" style={{ background: COLORS.card, padding: "80px 48px", borderTop: `1px solid ${COLORS.border}`, borderBottom: `1px solid ${COLORS.border}` }}>
...
export default function TenantIQLanding() {
      ...
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        @media (max-width: 640px) {
          ...
          [style*="padding: 80px 48px"] { padding: 64px 22px !important; }
          [style*="padding: 88px 48px"] { padding: 64px 22px !important; }
